...
#ifndef __QBUSMANAGERUTIL_H_
#define __QBUSMANAGERUTIL_H_
...
uint64_t MurmurHash64A(const void* key, int len, uint32_t seed = 0x12345678);

uint64_t MurmurHash64A(const std::string &key);
